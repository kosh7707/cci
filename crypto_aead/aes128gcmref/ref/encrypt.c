 ...
 *
 * Sources:
 *   GCM:    SUPERCOP crypto_aead/aes128gcmv1/ref (D.J.Bernstein)
 *   AES:    SUPERCOP crypto_core/aes128encrypt/ref (D.J.Bernstein)
...
/* ================================================================== */
/* Pure-C AES-128 block encrypt (no tables, no AES-NI)                */
/* ================================================================== */
...
static void aes128_encrypt(unsigned char *out, const unsigned char *in,
...
#define AES(out, in, k) aes128_encrypt(out, in, k)
...
/*
 * a = (a + x) * y in GF(2^128)
 * 16 bytes in a; xlen bytes in x (≤16, zero-padded); 16 bytes in y
 */
